...
if (isset($_POST['action']) && isset($_POST['request_id'])) {
    ...
    if ($action === 'approve') {
        ...
        if ($request) {
            ...
            $statusStmt = mysqli_prepare($conn, "UPDATE subject_change_requests SET status = 'Approved', approved_by = ?, approver_type = 'Admin', updated_at = NOW() WHERE id = ?");
            mysqli_stmt_bind_param($statusStmt, "ii", $admin_id, $request_id);
        ...
        $statusStmt = mysqli_prepare($conn, "UPDATE subject_change_requests SET status = 'Rejected', approved_by = ?, approver_type = 'Admin', updated_at = NOW() WHERE id = ? AND status = 'Pending'");
        mysqli_stmt_bind_param($statusStmt, "ii", $admin_id, $request_id);
        mysqli_stmt_execute($statusStmt);
...
<head>
    ...
    <title>Subject Change Approvals | Admin Panel</title>
    ...
    <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <ul class="space-y-1 px-3">
                ...
                <li>
                    <a href="subject_change_approvals.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-indigo-50 text-indigo-700 font-medium">
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Review and approve student subject change requests.</p>
                    </div>
                                    ...
                                    <div class="border border-gray-200 rounded-xl p-6 hover:shadow-md transition">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="bg-indigo-50 rounded-lg p-3 text-sm text-gray-700 whitespace-pre-line">
