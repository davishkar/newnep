...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // We expect an array of keys and values from the form
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <a href="manage_students.php" class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                        ...
                        <form method="POST" id="editForm" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            <div class="p-6 border-b border-gray-100 bg-gray-50">
                                <h2 class="text-lg font-bold text-gray-900 flex items-center gap-2">
                                    <i class="bi bi-person-lines-fill text-indigo-500"></i> Basic Information
                                </h2>
                            </div>
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="name" value="<?php echo htmlspecialchars($student['name']); ?>" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                        <input type="email" name="email" value="<?php echo htmlspecialchars($student['email']); ?>" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none" required>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <select name="year" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="mobile" value="<?php echo htmlspecialchars($student['mobile'] ?? ''); ?>" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">ABC ID</label>
                                        <input type="text" name="abc_id" value="<?php echo htmlspecialchars($student['abc_id'] ?? ''); ?>" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none">
                                    </div>
                                </div>
                                ...
                                <div class="pt-4 border-t border-gray-100">
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="password" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="••••••••">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden h-full flex flex-col">
                            <div class="p-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                                <h2 class="text-lg font-bold text-gray-900 flex items-center gap-2">
                                    <i class="bi bi-book text-indigo-500"></i> Subjects
                                </h2>
                                <button type="button" onclick="addSubjectField()" class="text-xs bg-indigo-100 text-indigo-700 px-2 py-1 rounded hover:bg-indigo-200 transition">
                            ...
                            <div class="p-6 flex-1 overflow-y-auto">
                                ...
                                <div id="subjectsContainer" class="space-y-3">
                                    ...
                                    <div class="flex gap-2">
                                        <input type="text" name="subject_keys[]" value="<?php echo htmlspecialchars($key); ?>" class="w-1/3 px-2 py-1.5 text-sm border rounded focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Key">
                                        <input type="text" name="subject_values[]" value="<?php echo htmlspecialchars($val); ?>" class="w-2/3 px-2 py-1.5 text-sm border rounded focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Subject Name">
                                    ...
                                    <div class="flex gap-2">
                                        <input type="text" name="subject_keys[]" class="w-1/3 px-2 py-1.5 text-sm border rounded focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Key (e.g. Major)">
                                        <input type="text" name="subject_values[]" class="w-2/3 px-2 py-1.5 text-sm border rounded focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Subject Name">
                                         <button type="button" onclick="this.parentElement.remove()" class="text-red-400 hover:text-red-600"><i class="bi bi-trash"></i></button>
                                    </div>
                                    <?php endif; ?>
                                </div>
                             ...
                             <div class="p-6 border-t border-gray-100 bg-gray-50">
                                <button type="submit" form="editForm" class="w-full py-2.5 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/20">
                                    Save All Changes
                                </button>
                            </div>
                        </div>
...
function addSubjectField() {
    ...
    div.innerHTML = `
        <input type="text" name="subject_keys[]" class="w-1/3 px-2 py-1.5 text-sm border rounded focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Key">
        <input type="text" name="subject_values[]" class="w-2/3 px-2 py-1.5 text-sm border rounded focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Subject Name">
        <button type="button" onclick="this.parentElement.remove()" class="text-red-400 hover:text-red-600"><i class="bi bi-trash"></i></button>
    `;
