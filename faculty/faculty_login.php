...
if (isset($_POST['login'])) {
    ...
    if ($_SESSION['login_attempts'] >= 5) {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            $stmt = mysqli_prepare($conn, "SELECT id, name, password FROM teachers WHERE email = ?");
...
<head>
    ...
    <title>Faculty Login | NEP Portal</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen font-sans">
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="bg-indigo-600 px-8 py-6 text-center">
            <h2 class="text-2xl font-bold text-white tracking-wide">Faculty Portal</h2>
            ...
            <form method="POST" onsubmit="return validateForm()">
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email" class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" placeholder="faculty@example.com" required>
                    </div>
